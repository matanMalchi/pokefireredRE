...
const u16 gMetatiles_tileTest[] = INCBIN_U16("data/tilesets/secondary/tile_test/metatiles.bin");
const u32 gMetatileAttributes_tileTest[] = INCBIN_U32("data/tilesets/secondary/tile_test/metatile_attributes.bin");
